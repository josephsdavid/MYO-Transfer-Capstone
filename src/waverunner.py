...
train = oneHotNina("../data/ninaPro", ['c'], [u.butter_highpass_filter],
                        [u.add_noise_snr], validation=False, by_subject = True, batch_size=batch,
                        scale = False, rectify=False)
test = oneHotNina("../data/ninaPro", ['c'], [u.butter_highpass_filter],
...
wn.fit(train, validation_data=test, epochs=100, callbacks=[clr], shuffle = False)
